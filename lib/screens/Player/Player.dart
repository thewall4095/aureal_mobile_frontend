                 ...
                 children: [
                   ...
                   GestureDetector(
                     onTap: () {
                       ...
                       print(episodeObject.episodeObject['podcast_image']);
                     ...
                     children: [
                       Container(
                         ...
                         decoration: new BoxDecoration(
                           // color: Colors.white,
                           border: Border.all(color: themeProvider.isLightTheme == false
                               ? Colors.white
                               : kPrimaryColor,),
                                 ...
                                 InkWell(
                                   onTap: () async {
                                     if (prefs.getString(
                                         ...
                                         null) {
                                       setState(() {
                                         episodeObject.episodeObject['isLoading'] =
                                         true;
                                       });
                                       double
                                       _value =
                                       ...
                                       showDialog(
                                           ...
                                           builder:
                                             ...
                                             return Dialog(
                                                 backgroundColor:
                                                 Colors.transparent,
                                                 child: UpvoteEpisode(permlink: episodeObject.episodeObject['permlink'], episode_id: episodeObject.episodeObject['id']));
                                           }).then((value) async {
                                         print(
                                             value);
                                       });
                                       setState(() {
                                         episodeObject.episodeObject['ifVoted'] =
                                         !episodeObject.episodeObject['ifVoted'];
                                       });
                                       setState(() {
                                         episodeObject.episodeObject['isLoading'] =
                                   ...
                                   child: Container(
                                     decoration: episodeObject.episodeObject[
                                     'ifVoted'] ==
                                         true
                                         ? BoxDecoration(
                                         gradient:
                                       ...
                                       child: Row(
                                         children: [
                                           ...
                                           Padding(
                                             ...
                                             child:
                                             Text(
                                               episodeObject.episodeObject['votes']
                                                   .toString(),
                                               textScaleFactor:
                                               1.0,
                                               style: TextStyle(
                                     ...
                                     Container(height: 15,width: 10,
                                                   decoration: BoxDecoration(
                                                         border: Border(left: BorderSide(color: themeProvider.isLightTheme == false
                                                  ? Colors.white
                                                      : kPrimaryColor,)),
                                                 ),),
                                           Padding(
