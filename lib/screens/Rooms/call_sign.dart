...
class CallBody extends StatefulWidget {
  ...
  CallBody({Key key, @required this.ip, @required this.roomId})
      : super(key: key);

  @override
  _CallBodyState createState() => _CallBodyState(serverIP: ip, roomId: roomId);
}
...
class _CallBodyState extends State<CallBody> {
  ...
  _CallBodyState({Key key, @required this.serverIP, @required this.roomId});
